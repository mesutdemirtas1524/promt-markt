...
export const dictionaries = {
  en: {
    ...
    "detail.customize.title": "Customize this prompt",
    "detail.customize.hint": "Fill in the highlighted parts, then copy your tailored version.",
    "detail.customize.preview": "Preview",
    "detail.customize.copyFilled": "Copy filled prompt",
    "detail.customize.copyOriginal": "Copy with placeholders",
    "detail.customize.reset": "Reset",
    "detail.customize.placeholder": "Enter {label}…",
  ...
  tr: {
    ...
    "detail.customize.title": "Bu promtu özelleştir",
    "detail.customize.hint": "Vurgulanan kısımları doldur, sonra kendine özel hâlini kopyala.",
    "detail.customize.preview": "Önizleme",
    "detail.customize.copyFilled": "Doldurulmuş promtu kopyala",
    "detail.customize.copyOriginal": "Yer tutucularla kopyala",
    "detail.customize.reset": "Sıfırla",
    "detail.customize.placeholder": "{label} gir…",
